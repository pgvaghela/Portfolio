...
// Each hero line gets its own delay slot
const line = (i: number) => ({
...
export default function MountainScene() {
  ...
  return (
    <main style={{ background: "#06090f" }}>
      ...
      {/*
        whileInView fades + lifts the whole section in.
        once: true so it only plays the first time.
        amount: 0.12 fires early — just 12% of the section needs to be visible.
      */}
      <motion.section
      ...
      >
        {/* Top gradient — mountain "rises" from the page colour */}
        <div
        ...
        <MountainCanvas onPeakClick={setActivePeak} />

        {/* Bottom bar: hint + back-to-top */}
        <motion.div
          initial={{ opacity: 0 }}
          whileInView={{ opacity: 1 }}
      ...
      {/* Modal — fixed, works across both sections */}
      {activePeak && (
